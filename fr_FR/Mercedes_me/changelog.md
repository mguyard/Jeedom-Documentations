...
> <span style="color:red">_Le plugin est désormais en privé (achat impossible) suite à l'annonce de la fin de l'API Bring Your Own Car ([Annonce](https://developer.mercedes-benz.com/news/bringyourowncar-sundown)) utilisé par ce plugin.
